...
//! bigrams. Cheap, easy to reason about, and tolerant of the common
//! variations between release titles and canonical series titles
//! (punctuation, romanization spelling, "vol. 3" suffixes, etc.).
//!
//! Lives in `td-metadata` so both the resolution pipeline and individual
//! providers (e.g. MangaBaka's offline store re-ranks FTS hits with this)
